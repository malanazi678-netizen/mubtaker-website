...
const LOGO = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663392323714/awOJYiKKunlkJuOx.png";
const HERO_IMG = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663392323714/EhJycotaHsKUEQHI.png";
const SERVICES_COFFEE_IMG = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663392323714/KlbzMxxxpgaeeFFG.png";
const ECOMMERCE_IMG = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663392323714/tAbBhGzDRHRzBFBX.png";
const MARKETING_IMG = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663392323714/VMomBAGZOymOQePj.png";
const RESULTS_IMG = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663392323714/JUUVUhKVffwzHbUP.png";
const FINAL_CTA_IMG = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663392323714/fVpcQHbQZfuEuKIn.png";
const WHATSAPP_NUMBER = "966559999236";
const MAROOF_LOGO = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663392323714/jNHKLCjgXLOyOuDx.png";
const MINISTRY_LOGO = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663392323714/FYiOACPDdZEkDJqj.png";
const VERIFICATION_LOGO = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663392323714/WqSTsfwGzJLgiKwd.png";
...
const resultMetrics = [
  ...
  { value: "2", unit: "نماذج", label: "أعمال مختارة", note: "تجارة · محتوى" },
];
...
const paymentBrands = [
  { name: "تابي", mark: "tabby", className: "payment-brand-tabby" },
  { name: "تمارا", mark: "tamara", className: "payment-brand-tamara" },
  { name: "مدفوع", mark: "مدفوع", className: "payment-brand-madfu" },
  { name: "Visa", mark: "VISA", className: "payment-brand-visa" },
  { name: "مدى", mark: "mada", className: "payment-brand-mada" },
];
    ...
    <div dir="rtl" style={{ fontFamily: "'Cairo', sans-serif", background: unifiedBg, minHeight: "100vh", color: dark }}>
      <nav style={{ position: "fixed", top: 0, right: 0, left: 0, zIndex: 50, transition: "all 0.3s", background: scrolled ? "rgba(248,246,255,0.88)" : "transparent", backdropFilter: scrolled ? "blur(16px)" : "none", borderBottom: scrolled ? "1px solid rgba(107,159,212,0.12)" : "none", boxShadow: scrolled ? "0 4px 24px rgba(107,159,212,0.08)" : "none" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 1.5rem", display: "flex", alignItems: "center", justifyContent: "space-between", height: 72 }}>
          <img src={LOGO} alt="مبتكر" loading="eager" decoding="async" style={{ height: 48, objectFit: "contain" }} />
        ...
        <div ref={hero.ref} style={{ maxWidth: 1280, margin: "0 auto", padding: "0 1.5rem", width: "100%", position: "relative", zIndex: 2 }}>
          <div className="hero-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.12fr", gap: "3rem", alignItems: "center" }}>
            ...
            <div className="hero-visual-wrap" style={{ opacity: hero.visible ? 1 : 0, transform: `${hero.visible ? "none" : "translateX(-30px)"} translate3d(${reducedMotion ? 0 : heroParallax.x * -0.28}px, ${reducedMotion ? 0 : heroParallax.y * -0.28}px, 0)`, transition: "opacity 0.7s cubic-bezier(0.23,1,0.32,1) 0.2s, transform 0.18s ease-out" }}>
              ...
              <img src={HERO_IMG} alt="الشخصية السعودية الرئيسية في هوية مبتكر" className="hero-main-character" loading="eager" fetchPriority="high" decoding="async" />
      ...
      <section id="services" className="creative-section coffee-section" ref={servicesSection.ref}>
        <div className="section-shell coffee-layout">
          ...
          <div className="coffee-visual" style={{ opacity: servicesSection.visible ? 1 : 0, transform: servicesSection.visible ? "none" : "translateX(-26px)", transition: "all 700ms cubic-bezier(0.23,1,0.32,1) 120ms" }}><div className="coffee-halo" /><img src={SERVICES_COFFEE_IMG} alt="الشخصية السعودية تشرب القهوة بجانب اللابتوب والدلة" loading="lazy" decoding="async" /><div className="coffee-stamp">على كيفك<br /><b>نضبطها</b></div></div>
        </div>
      ...
      <section id="ecommerce" className="creative-section ecommerce-section" ref={ecommerceSection.ref}>
        <div className="section-shell ecommerce-layout">
          <div className="ecommerce-visual" style={{ opacity: ecommerceSection.visible ? 1 : 0, transform: ecommerceSection.visible ? "none" : "translateX(26px)", transition: "all 700ms cubic-bezier(0.23,1,0.32,1)" }}><div className="commerce-ring" /><img src={ECOMMERCE_IMG} alt="الشخصية السعودية جالسة وسط كراتين الشحن وتمسك هاتفاً يعرض متجراً إلكترونياً" loading="lazy" decoding="async" /><div className="commerce-float bag"><ShoppingBag size={17} /><span>Shopping Bag</span></div><div className="commerce-float order"><Bell size={16} /><span>طلب جديد</span></div><div className="commerce-float cart"><CreditCard size={16} /><span>Cart</span></div><div className="commerce-float sale"><TrendingUp size={16} /><span>Sales</span></div></div>
      ...
      <section id="marketing" className="creative-section marketing-section" ref={marketingSection.ref}>
        <div className="section-shell marketing-layout">
          ...
          <div className="marketing-visual" style={{ opacity: marketingSection.visible ? 1 : 0, transform: marketingSection.visible ? "none" : "translateX(-24px)", transition: "all 700ms cubic-bezier(0.23,1,0.32,1) 120ms" }}><img src={MARKETING_IMG} alt="الشخصية السعودية تحمل مسجلاً قديماً Boombox" loading="lazy" decoding="async" /></div>
        </div>
      </section>
      ...
      <section id="results" className="results-section" ref={resultsSection.ref}>
        <div className="section-shell results-layout">
          <Reveal visible={resultsSection.visible} className="results-copy">
            ...
            <div className="payment-strip" aria-label="شعارات وسائل الدفع المستخدمة لدى المتاجر والبوابات المتصلة"><span className="payment-strip-label">خيارات دفع تدعمها المتاجر والبوابات المتصلة</span><div className="payment-brand-list">{paymentBrands.map((brand) => <span className={`payment-brand ${brand.className}`} key={brand.name} aria-label={brand.name}>{brand.mark}</span>)}</div></div>
          </Reveal>
          <div className="results-visual" style={{ opacity: resultsSection.visible ? 1 : 0, transform: resultsSection.visible ? "none" : "translateX(-22px)", transition: "all 700ms cubic-bezier(0.23,1,0.32,1) 120ms" }}>
            <img src={RESULTS_IMG} alt="الشخصية السعودية واقفة وتحمل جهازاً لوحياً لمتابعة النتائج" className="results-character" loading="lazy" decoding="async" />
                          <div className="results-work-strip" aria-label="أعمال مختارة">{caseStudies.map((work) => <div className="results-work" key={work.title}><img src={work.image} alt="" loading="lazy" decoding="async" /><div><b>{work.title}</b><small>{work.tag}</small></div></div>)}</div>
      ...
      <style>{`
        ...
        .section-eyebrow{display:inline-flex;align-items:center;gap:8px;margin-bottom:22px;color:#6B9FD4;font-size:16px;font-weight:900;letter-spacing:.02em}
